...
const Login = () => {
    ...
    return (
        <div style={{ backgroundColor: '#c8e7f0' }}>
            ...
            <form className='form' onSubmit={handelLoginForm}>
                ...
                <Form.Group className="mb-3 " controlId="formBasicEmail">
                    ...
                    <Form.Control className='input-fild shadow-none' ref={emailRef} type="email" placeholder="Enter email" required />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicPassword">
                    {/* <Form.Label>Password</Form.Label> */}
                    <Form.Control className='input-fild shadow-none' ref={passwordRef} type="password" placeholder="Password" required />
                </Form.Group>
